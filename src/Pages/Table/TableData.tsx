...
const TableData = ({ data }:Props) => {
  ...
  const [tableData, setTableData] = useState<InitialStateType[]>();
    ...
    <div>
      ...
      <table style={mystyle}>
        <tbody>
          <tr>
          <th style={headerType}>
              <button style={tableHeader}>Date</button>
            </th>
            <th 
            // onClick={() => handleTableData({ sort: "month" })}
            >
              <button style={tableHeader}> Month Year 
              {/* {getArrow(order)} */}
              </button>
            </th>
            <th
            ...
            <th 
            // onClick={() => handleTableData({ sort: "toAccount" })}
            >
              <button style={tableHeader}> To Account
               {/* {getArrow(order)} */}
               </button>
            </th>
            <th 
            // onClick={() => handleTableData({ sort: "amount" })}
            >
              <button style={tableHeader}> Amount 
              {/* {getArrow(order)} */}
              </button>
            </th>
            <th style={headerType}>
            ...
            >
              <button style={tableHeader}> Notes 
              {/* {getArrow(order)} */}
              </button>
            </th>
            <th>
      ...
      {data.length > 0 &&
        data.slice(indexOfFirst,indexOfLast).map((data, index) => (
          <tr key={index}>
            {/* <td>{datar.id}</td> */}
